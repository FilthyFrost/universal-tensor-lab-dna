...
- Follow-up: reworked CA from long drooping spikes into catfish-inspired barbels. The main manifold now only forms cheek/mouth roots, while six anchored low-poly tapered barbel tubes provide the visible short curved whisker silhouette. QA: head atlas `qa-atlas/latest-v30-head-whisker` generated 48 screenshots with browser errors `[]`; CA head case is 2,800 faces. User-like DNA `AA-AG-CA-TG-GC-GA` rendered at 2,892 faces with browser errors `[]`.
